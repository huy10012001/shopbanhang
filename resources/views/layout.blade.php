...
<head>
    ...
    <![endif]-->
    <link rel="shortcut icon" href="{{ ('public/fronend/img/ico/favicon.ico') }}">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="{{ URL::to('/trang-chu') }}"><img src="{{ ('public/fronend/img/logo.png') }}" alt="" /></a>
                        </div>
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{ ('public/fronend/img/girl1.jpg') }}" class="girl img-responsive" alt="" />
                                    <img src="{{ ('public/fronend/img/pricing.png') }}" class="pricing" alt="" />
                                </div>
                            </div>
                            <div class="item">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{ ('public/fronend/img/girl2.jpg') }}" class="girl img-responsive" alt="" />
                            ...
                            <div class="item">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{('public/fronend/img/girl3.jpg')}}" class="girl img-responsive" alt="" />
                                    <img src="{{ ('public/fronend/img/pricing.png') }}" class="pricing" alt="" />
                                </div>
                            </div>
